...
Keep the project's npm dependency tree secure, current, and verifiably buildable. This capability defines the standards a dependency change must meet: a vulnerability-free audit, direct dependencies on supported versions, and validated builds before shipping.
